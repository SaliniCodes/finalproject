        ...
        actions: [
          ...
          IconButton(
            ...
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => History(token: '',id:widget.userId)),
                              ...
                              if (textEditingController.text.isNotEmpty) {
                                ...
                                chatBloc.add(
                                  ChatGenerateNewTextMessageEvent(
                                    inputMessage: "make a recipe using the given ingredients $text ,if the given ingredients ar not a food item then reply with give proper ingredients .",
                                  ),
                                );
                              }
                            },
...
//
//   @override
//   State<Searchall> createState() => _SearchState();
// }
//
// class _SearchState extends State<Searchall> {
